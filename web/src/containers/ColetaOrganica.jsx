...
let ColetaOrganica = props => {
    ...
    return (
        <form onSubmit={handleForm} className="form-group">
            ...
            <h3 className="box-title">Coleta Orgânica</h3>
                ...
                <div className="box-body">
                        ...
                        <div className="row mb-3">
                            <div className="col-md-6">
                                ...
                                <div className="input-group">
                                    {/* <span className="input-group-addon"><i className="fas fa-signature"/></span> */}
                                    <Field name='organic' component="select" className="form-control select">
...
ColetaOrganica =  reduxForm({ form: 'newColetaForm' })(ColetaOrganica)   // A unique identifier for this form	
